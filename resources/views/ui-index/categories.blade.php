                ...
                <form id="filterForm" class="mt-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check mt-3" style="padding-left: 1.85rem; padding-top: 2rem; font-size: 1.4rem;">
                                <input class="form-check-input" type="checkbox" id="on_sale" name="on_sale_filter" value="1" style="cursor: pointer; margin-top: 0.25rem;">
                                <label class="form-check-label fw-semibold" for="on_sale" style="margin-left: 0.5rem; cursor: pointer; color: white; font-size: 1rem;">
                                    Chỉ hiện sản phẩm đang sale 🔥
                                </label>
                            </div>
                        </div>
                    </div>
