...
@section('content')
    ...
    <div class="background-details w-100 vh-100 bg-light">
        <div class="container-details container bg-success">
            <div class="row">
                <!-- Cột trái: Hình ảnh sản phẩm -->
                <div class="col-md-6">
                    <div class="product-images text-center">
                        <img src="{{ asset('images/test.jpg') }}" class="prodcut-image" alt="Ảnh sản phẩm chính"
                            id="mainImage">
                ...
                <div class="col-md-6">
                    <h3 class="fw-bold text-center">{{ $product->product_name ?? "Sản phẩm mẫu"}}</h3>
                    ...
                    <p class="mt-3"><strong>Nhà phân phối: </strong> {{ $product->supplier->name ?? "Không rõ"}}</p>
                    ...
                    <div class="mt-4 d-flex align-items-center">
                        ...
                        <input type="number" class="input-quantity form-control text-center" 
                            max="{{ isset($product->stock_quantity) ? $product->stock_quantity : 0 }}" value="{{ isset($product->stock_quantity) ? 1 : 0 }}">
                        <img class="quantity-button plus ms-1" src="{{ asset('images/plus.png') }}" alt="">
                        <p class="mt-3 ms-3" >{{ isset($product->stock_quantity) ? $product->stock_quantity . ' sản phẩm có sẵn' : 'Hết Hàng' }}</p>
                    </div>
